...
│   ├── openai_scraper.py   # Scraper class (OpenAIScraper) and Pydantic models for OpenAI blog
│   ├── youtube_scraper.py  # Scraper class (YouTubeScraper) and Pydantic models for YouTube channels
